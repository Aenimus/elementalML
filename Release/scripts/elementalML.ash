...
void main(float monster_natural_ML) {
    ...
    print("You will take approximately " + rounder(damage(monster_natural_ML, stench),-1) + " from a sleaze monster's initial elemental hit.", "green");
    print("You will take approximately " + rounder(damage(monster_natural_ML, sleaze),-1) + " from a stench monster's initial elemental hit.", "purple");	
