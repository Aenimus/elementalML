...
float damage(float monster_natural_ML, element ele) {
    return  virginDMG(monster_natural_ML) * (elemental_resistance(ele)/100);
}
...
void main(float monster_natural_ML) {
    ...
    print("You will take approximately " + rounder(damage(monster_natural_ML, stench),0) + " from a sleaze monster's initial elemental hit.", "green");
    print("You will take approximately " + rounder(damage(monster_natural_ML, sleaze),0) + " from a stench monster's initial elemental hit.", "purple");	
